...
-- Volcando estructura para vista evaluacioninstructores.bancopreguntas
...
INSERT INTO `detalle_cuestionariom` (`id`, `FK_Cuestionario`, `FK_Ficha`, `FK_Instructor`, `created_at`, `updated_at`) VALUES
	...
	(2, 2, 2, 4, '2015-11-06 12:41:46', '2015-11-06 12:41:46');
...
INSERT INTO `detalle_fichasm` (`id`, `FK_Ficha`, `FK_Instructor`, `Titular`, `created_at`, `updated_at`) VALUES
	...
	(6, 2, 5, 'Si', '2015-11-06 12:51:54', '2015-11-06 12:51:54');
...
-- Volcando datos para la tabla evaluacioninstructores.detalle_preguntam: ~10 rows (aproximadamente)
...
INSERT INTO `detalle_preguntam` (`id`, `FK_Pregunta`, `FK_Cuestionario`, `created_at`, `updated_at`) VALUES
	...
	(6, 10, 1, '2015-11-03 14:31:36', '2015-11-03 14:31:36'),
...
INSERT INTO `ficham` (`id`, `Numero`, `FK_Coordinacion`, `FK_Programa`, `created_at`, `updated_at`) VALUES
	(1, 913526, 1, 1, '2015-09-10 15:12:49', '2015-11-06 12:41:19'),
	(2, 912296, 2, 1, '2015-11-06 12:41:01', '2015-11-06 12:45:24');
...
-- Volcando datos para la tabla evaluacioninstructores.migrations: ~18 rows (aproximadamente)
...
INSERT INTO `pregunta` (`Id_pregunta`, `Tipo_pregunta`, `Descripcion`, `FK_Saber`) VALUES
	...
	(2, 'Unica', '¿Es hombre o mujer?', NULL);
...
INSERT INTO `preguntam` (`id`, `Descripcion`, `FK_Saber`, `created_at`, `updated_at`) VALUES
	...
	(8, '¿Utiliza correctamente los materias brindados por las instalaciones?', 2, '2015-11-03 14:29:50', '2015-11-03 14:29:50'),
...
INSERT INTO `programa` (`Codigo`, `Nombre`, `Descripcion`) VALUES
	(14, 'hermanitas calle', 'TEQUIEROMUSHOOOMUA<3'),
	(1111, 'ADSI', 'TECNOLOGO'),
...
-- Volcando datos para la tabla evaluacioninstructores.saberm: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla evaluacioninstructores.users: ~101 rows (aproximadamente)
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	...
	(101, 'Daniel', 'alonzo333@hot.com', '$2y$10$VxeLBgbXySruIHtSBqDSsuoeoOMdw9zt52HArSItEdKVjf4HTqZTy', '7QLUqoaUKGINLLnS1n5PoocOi1uTrekDTwqzJeMfaViR0yx7vNAmX7JFMDH2', '2015-10-13 16:24:20', '2015-10-13 16:24:24');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` VIEW `bancopreguntas` AS SELECT
saber.Nombre,
pregunta.Descripcion,
respuesta.Valor_Respuesta
FROM
saber
INNER JOIN pregunta ON pregunta.FK_Saber = saber.Codigo
INNER JOIN respuesta ON respuesta.FK_Pregunta = pregunta.Id_pregunta ;
